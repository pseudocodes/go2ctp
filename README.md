...
> 2. 早期更新 CTP 库版本时，需要修改部分 CTP 头文件内容，例如行情接口 `SubscribeMarketData` 的合约参数声明方式需要修改，否则 *swig* 在生成接口时无法生成 `__goslice__` 模式的参数，该问题 2016 年提出直到 2022 年 swig 才修复 [#749](https://github.com/swig/swig/issues/749)
...
> 
> A.04: 开发者没有 Windows 环境，不想装虚拟机，大家可以提 PR
